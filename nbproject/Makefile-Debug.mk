...
${OBJECTDIR}/CodeTableBuilder.o: CodeTableBuilder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CodeTableBuilder.o CodeTableBuilder.cpp
...
${OBJECTDIR}/FrequencyTally.o: FrequencyTally.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FrequencyTally.o FrequencyTally.cpp

${OBJECTDIR}/HuffmanEncode.o: HuffmanEncode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HuffmanEncode.o HuffmanEncode.cpp
...
${OBJECTDIR}/HuffmanTreeBuilder.o: HuffmanTreeBuilder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HuffmanTreeBuilder.o HuffmanTreeBuilder.cpp
